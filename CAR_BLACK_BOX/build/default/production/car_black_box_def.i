    ...
    if(i == 4)
    {
        ...
        else
        {
            ...
            else
            {
              clear_screen();
              clcd_write(0x0C, 0);
              clcd_print("Wrong password", (0x80 + 2));
...
void view_log(unsigned char key, unsigned char reset_flag)
{
    ...
    else
    {
        ...
        if(key == 0x37 && view_pos > 0)
        {

            view_pos--;
        }
        else if(key == 0x2F && view_pos < access)
        {
            view_pos++;
        }
        ...
        clcd_putch(view_pos%10 +'0', (0xC0 + 0));
        clcd_putch(view_log[0], (0xC0 + 2));
        clcd_putch(view_log[1], (0xC0 + 3));
        clcd_putch(':', (0xC0 + 4));

        clcd_putch(view_log[2], (0xC0 + 5));
        clcd_putch(view_log[3], (0xC0 + 6));
        clcd_putch(':', (0xC0 + 7));

        clcd_putch(view_log[4], (0xC0 + 8));
        clcd_putch(view_log[5], (0xC0 + 9));

        clcd_putch(view_log[6], (0xC0 + 11));
        clcd_putch(view_log[7], (0xC0 + 12));

        clcd_putch(view_log[8], (0xC0 + 14));
        clcd_putch(view_log[9], (0xC0 + 15));
